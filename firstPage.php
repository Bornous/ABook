...
<body>
	...
	<?php
		...
		echo	"<div class='redText' ><span class='dialog_2'>Co się stało z Carilim zaraz po świętach.</span></div>";
	...
	<div class="right_runes"><img src="graphics/long_stand_bar_with_places.png"/></div>
